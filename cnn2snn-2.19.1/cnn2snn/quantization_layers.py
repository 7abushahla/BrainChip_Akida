...
def _check_unsupported_args(kwargs, unsupported_args):
    ...
    Unsupported arguments: 'data_format', 'activation', 'depth_multiplier'.
...
class QuantizedDense(layers.Dense):
    ...
    def call(self, inputs):
        ...
        if rank == 2 or rank is None:
            ...
            # gradients. This can lead to significant speedups, see b/171762937.
...
class ActivationDiscreteRelu(QuantizedActivation):
    ...
    For bitwidth > 2, with N = 2^bitwidth - 1:
